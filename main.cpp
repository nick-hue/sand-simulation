...
void DrawGrid()
{
    ...
    DrawLine(0, SCREEN_HEIGHT+1, SCREEN_WIDTH, SCREEN_HEIGHT+1, LINE_COLOR);
...
void DrawSelection(){
    ...
    if (IsMouseButtonDown(MOUSE_BUTTON_LEFT)){
        ...
        grid[cell_x][cell_y].color = getRandomColor();
